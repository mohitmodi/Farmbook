...
public class Register extends FarmbookActivity {
	...
	public void validate() {
		...
		try {
			String response = CustomHttpClient.executeHttpPost("sln/register.php", postParameters);
			...
			if(response.equals("1")) {
				...
				ArrayList<NameValuePair> imagePostParameters = new ArrayList<NameValuePair>();
				imagePostParameters.add(new BasicNameValuePair("phoneno",getStuffApplication().getPhonenumber()));
				imagePostParameters.add(new BasicNameValuePair("image",image_str));
				imagePostParameters.add(new BasicNameValuePair("imagepath","profilepic.jpg"));

				Log.i("Register","Sending..........");
				CustomHttpClient.executeHttpPost("sln/uploadimage.php", imagePostParameters);
